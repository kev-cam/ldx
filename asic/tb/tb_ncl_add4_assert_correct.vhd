-- tb_ncl_add4_assert_correct.vhd — 4-bit async NCL ripple adder with
...
entity tb_ncl_add4_assert_correct is
end entity;

architecture sim of tb_ncl_add4_assert_correct is
...
begin
  ...
  fa2 : entity work.nclfa_hybrid_evt
  ...
  fa3 : entity work.nclfa_hybrid_evt
