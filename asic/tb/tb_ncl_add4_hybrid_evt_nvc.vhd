-- tb_ncl_add4_hybrid_evt_nvc.vhd — 4-bit ripple-carry NCL adder built
-- from 4× nclfa_hybrid_evt instances. Proves the NN-hybrid cells scale
...
entity tb_ncl_add4_hybrid_evt_nvc is
end entity;

architecture sim of tb_ncl_add4_hybrid_evt_nvc is
