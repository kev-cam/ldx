# sockit_pll.tcl — Terasic SoCKit Rev D (Cyclone V SX 5CSXFC6D6F31C6) build
...
project_new sockit_pll -overwrite
set_global_assignment -name FAMILY "Cyclone V"
set_global_assignment -name DEVICE 5CSXFC6D6F31C6
set_global_assignment -name TOP_LEVEL_ENTITY sockit_pll_top
...
set_global_assignment -name VERILOG_FILE /usr/local/src/ldx/fpga/quartus/mbarray_de2i/de2i_arr_top.v
set_global_assignment -name VERILOG_FILE /usr/local/src/ldx/fpga/quartus/mbarray_sockit/sockit_pll_top.v
set_global_assignment -name SDC_FILE sockit_pll.sdc
