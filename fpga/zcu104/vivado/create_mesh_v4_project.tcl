## ZCU104 ldx variant: 5x5 mesh with v4 (iverilog/vvp) CFU.
## Same mesh as create_mesh_project.tcl, but ldx_cfu.v is swapped for
## ldx_cfu_v4.v which wires the c2v-emitted v4 gates from
## simulators/iverilog/ into per-core CFU slots.

set script_dir [file dirname [file normalize [info script]]]
set zcu_dir    [file dirname $script_dir]
set repo_root  [file dirname [file dirname $zcu_dir]]

set proj_name   "zcu104_ldx_mesh_v4"
set proj_dir    "$script_dir/build/$proj_name"
set part        "xczu7ev-ffvc1156-2-e"
set board_part  "xilinx.com:zcu104:part0:1.1"
set bd_name     "system"
set rtl_dir     "$zcu_dir/rtl"
set v4_dir      "$repo_root/simulators/iverilog"
...
add_files -norecurse [list \
    ...
    $rtl_dir/fifo.v \
    $rtl_dir/ldx_cfu_v4.v \
    $v4_dir/v4_xor_a32.v \
    $v4_dir/v4_and_a32.v \
    $v4_dir/v4_or_a32.v \
    $v4_dir/v4_not_a32.v \
    $v4_dir/v4_add_a32.v \
    $v4_dir/v4_add_cout.v \
