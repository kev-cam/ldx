## ZCU104 ldx mesh variant: per-core CFU specialised for SHA-256.
## Same mesh topology as create_mesh_project.tcl, but ldx_cfu.v is
## swapped for ldx_cfu_sha.v with EP0/EP1/SIG0/SIG1 at fn 0..3.

set script_dir [file dirname [file normalize [info script]]]
set zcu_dir    [file dirname $script_dir]
set repo_root  [file dirname [file dirname $zcu_dir]]

set proj_name   "zcu104_ldx_mesh_sha"
...
add_files -norecurse [list \
    ...
    $rtl_dir/fifo.v \
    $rtl_dir/ldx_cfu_sha.v \
    $rtl_dir/cfu_vl_sha_ep0.v \
    $rtl_dir/cfu_vl_sha_ep1.v \
    $rtl_dir/cfu_vl_sha_sig0.v \
    $rtl_dir/cfu_vl_sha_sig1.v \
