...
all: libldx.so test/test_basic test/test_preload test/preload_hook.so
...
test: test/test_basic test/test_preload test/preload_hook.so
...
clean:
	rm -f libldx.so test/test_basic test/test_preload test/preload_hook.so
